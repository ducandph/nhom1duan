    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <form class="row" method="post" action="index.php?act=addsp" enctype="multipart/form-data" >
            <!-- masp -->
  <div class="form-group col-md-3">
    <label class="control-label">Mã sản phẩm </label>
    <input class="form-control" type="number" name="ma_sp" placeholder="">
  </div>
  <!-- tensp -->
  <div class="form-group col-md-3">
...
<!-- ảnh -->
    ...
    <select class="form-control" name="ma_dm">
  ...
  <div class="form-group col-md-3">
    ...
    <input class="form-control" type="date" name="ngay_cap_nhat">
  </div>
  ...
  <input type="submit" name="themmoi" value="Thêm mới"></a>
