        ...
        <div class="tile">
          ...
          <div class="tile-body">
            <div class="row element-button">
              <form class="row" action="index.php?act=addm" method="POST" enctype="multipart/form-data">
              <div class="form-group col-md-3">
                  <label class="control-label">Mã danh mục</label>
                  <input class="form-control" type="text" name="ma_dm">
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-12">
                <label for="control-label" class="form-label">Tải ảnh lên</label>
                      <div class="file-upload-wrapper">
                              <input type="file" id="form-category/image" name="img" class="file-upload" required />
                      </div>
                      </div>
                ...
                <input type="submit" value="thêm mới" name="themoi" class="btn btn-save">
